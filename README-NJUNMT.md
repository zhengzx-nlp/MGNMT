...
### 3. Training
We can setup a training task by running following script on the __base__ directory:
...
We can translation any text by running following script on the __base__ directory:
